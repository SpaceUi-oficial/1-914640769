  ...
  return (
    <nav className="bg-[#1416187e] fixed w-full top-0 left-0 z-50">
      <div className="container mx-auto px-4 py-4 flex items-center justify-center relative group">
        ...
        {/* Menú desplegable */}
        <div 
          className={`fixed top-12 left-0 w-screen bg-[#141618] text-white p-4 border-t border-gray-700 transition-transform duration-300 ease-in-out ${hovered ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-[-20px]'}`}
          style={{ zIndex: 100 }}
        >
          {hovered === 'home' && (
            <div>

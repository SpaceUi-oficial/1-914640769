...
export default function Home() {
  ...
  const texts: { title: string; description1: string }[] = [
    { title: "Título 1", description1: "Descripción 1" },
    { title: "Título 2", description1: "Descripción 2" },
    { title: "Título 3", description1: "Descripción 3" },
    { title: "Título 4", description1: "Descripción 4" },
    { title: "Título 5", description1: "Descripción 5" },
    { title: "Título 6", description1: "Descripción 6" },
    { title: "Título 7", description1: "Descripción 7" },
    { title: "Título 8", description1: "Descripción 8" },
  ];
